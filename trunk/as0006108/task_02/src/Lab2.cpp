...
double calc__uk(double eeeeee_1, double eeeeee_2, double eeeeee_3){
/**
...
* setpoint_ += (q1 * eeeeee_1 + q2 * eeeeee_2 + q3 * eeeeee_3);
* 
* return setpoint_;
* \endcode
*/
...
* 
*   eeeeee_1 = need - y;
*   u = calc__uk(eeeeee_1, eeeeee_2, eeeeee_3);
*   y = linear.calcPIDMod(start, u);
*   fout << "E=" << eeeeee_1 << " Y=" << y << " U=" << u << std::endl;
* 
*   eeeeee_3 = eeeeee_2;
*   eeeeee_2 = eeeeee_1;
*   }
